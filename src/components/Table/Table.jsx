...
const ReportTable = () => {
  ...
  try {
    ...
    console.log("📡 Making request to: https://health-app-backend-v1.onrender.com/api/reports/");

    const response = await axios.get("https://health-app-backend-v1.onrender.com/api/reports/", {
      headers: headers,
    });
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://health-app-backend-v1.onrender.com/api/reports/${id}/`, {
        headers: {
          Authorization: `Bearer ${idToken}`,
          'Content-Type': 'application/json',
        },
            ...
            reports.map((report) => (
              <tr key={report.id}>
                ...
                <td>
                  <button
                    onClick={() => {
                      setModalImage(`https://health-app-backend-v1.onrender.com${report.original_file}`);
